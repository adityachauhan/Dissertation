...
def main():
    ...
    r = np.genfromtxt('datasets/RawData_second.csv',delimiter=',', names=True,case_sensitive=True,dtype = 'int')
    t = np.genfromtxt('datasets/RawData_time_second.csv',delimiter=',', names=True,case_sensitive=True,dtype = 'float')
    ...
    with open('Results/MPS_per_AnimalID_250_70.csv','w') as csvfile:
